...
(function () {
    ...
    function renderQ10() {
        ...
        input2.setAttribute("id", "radio_" + questionNumber + "_0");
        input2.setAttribute("name", "q" + questionNumber)
        input2.setAttribute("value", "a");

        label2.className = "form-check-label";
        label2.setAttribute("for", "radio_" + questionNumber + "_0");
        ...
        divFormCheck4.appendChild(input5);
        divFormCheck4.appendChild(label5);

        divFormCheck4.appendChild(input6);
        divFormCheck4.appendChild(label6);

        divFormCheck4.appendChild(input99);
        divFormCheck4.appendChild(label99);
