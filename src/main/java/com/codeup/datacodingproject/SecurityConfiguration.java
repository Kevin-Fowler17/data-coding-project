package com.codeup.datacodingproject;

import com.codeup.datacodingproject.services.UserDetailsLoader;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeHttpRequests()
                .requestMatchers("/", "/register",  "/survey", "/posts", "/posts/{id}", "/audio/**", "/css/**", "/img/**", "/js/**") // anyone can see the home and the posts pages
                .permitAll()
        ;
        return http.build();
    }
